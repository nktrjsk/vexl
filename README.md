...
# vexl - An [LNbits](https://github.com/lnbits/lnbits) Extension
...
1. run `./updateExtensionName.sh vexl:<yourextensionname> vexl:<yourExtensionName> vexl:<YourExtensionName>` (to replace all variations)
